...
func _ready():
	...
	self.connect("show_unequipped", get_node("/root/MyItems/Content/ItemList"), "_show_unequipped_items")
	add_item("Filter", 0)
	add_item("Head", 1)
